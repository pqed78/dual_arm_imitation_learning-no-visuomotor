#!/bin/bash
# ==============================================================================
# Dual Arm Imitation Learning Project - Auto Reconstruction Script
#
# 이 스크립트를 실행하면 현재 디렉토리에 프로젝트의 폴더 구조와 소스 코드가
# 동일하게 자동 복원(생성)됩니다.
# 사용법: bash recreate_project.sh
# ==============================================================================

echo "🚀 Dual Arm IL 프로젝트 복원을 시작합니다..."

echo "📁 생성 중: README.md"
cat << 'EOF_RECONSTRUCT' > 'README.md'
...
echo "📁 생성 중: __init__.py"
cat << 'EOF_RECONSTRUCT' > '__init__.py'
# Dual Arm Imitation Learning Package
EOF_RECONSTRUCT

echo "📁 생성 중: configs/act_cfg.yaml"
mkdir -p 'configs'
cat << 'EOF_RECONSTRUCT' > 'configs/act_cfg.yaml'
...
echo "📁 생성 중: configs/bc_cfg.yaml"
mkdir -p 'configs'
cat << 'EOF_RECONSTRUCT' > 'configs/bc_cfg.yaml'
...
echo "📁 생성 중: configs/diffusion_cfg.yaml"
mkdir -p 'configs'
cat << 'EOF_RECONSTRUCT' > 'configs/diffusion_cfg.yaml'
...
echo "📁 생성 중: configs/env_cfg.py"
mkdir -p 'configs'
cat << 'EOF_RECONSTRUCT' > 'configs/env_cfg.py'
...
echo "📁 생성 중: dataset/il_dataset.py"
mkdir -p 'dataset'
cat << 'EOF_RECONSTRUCT' > 'dataset/il_dataset.py'
# Copyright (c) 2026, Dual Arm Imitation Learning Project.
# SPDX-License-Identifier: BSD-3-Clause
...
echo "📁 생성 중: models/__init__.py"
mkdir -p 'models'
cat << 'EOF_RECONSTRUCT' > 'models/__init__.py'
# Copyright (c) 2026, Dual Arm Imitation Learning Project.
# SPDX-License-Identifier: BSD-3-Clause
...
echo "📁 생성 중: models/act/__init__.py"
mkdir -p 'models/act'
cat << 'EOF_RECONSTRUCT' > 'models/act/__init__.py'
# Copyright (c) 2026, Dual Arm Imitation Learning Project.
# SPDX-License-Identifier: BSD-3-Clause
...
echo "📁 생성 중: models/act/act_policy.py"
mkdir -p 'models/act'
cat << 'EOF_RECONSTRUCT' > 'models/act/act_policy.py'
# Copyright (c) 2026, Dual Arm Imitation Learning Project.
# SPDX-License-Identifier: BSD-3-Clause
...
echo "📁 생성 중: models/act/transformer.py"
mkdir -p 'models/act'
cat << 'EOF_RECONSTRUCT' > 'models/act/transformer.py'
# Copyright (c) 2026, Dual Arm Imitation Learning Project.
# SPDX-License-Identifier: BSD-3-Clause
...
echo "📁 생성 중: models/bc/__init__.py"
mkdir -p 'models/bc'
cat << 'EOF_RECONSTRUCT' > 'models/bc/__init__.py'
# Copyright (c) 2026, Dual Arm Imitation Learning Project.
# SPDX-License-Identifier: BSD-3-Clause
...
echo "📁 생성 중: models/bc/bc_policy.py"
mkdir -p 'models/bc'
cat << 'EOF_RECONSTRUCT' > 'models/bc/bc_policy.py'
# Copyright (c) 2026, Dual Arm Imitation Learning Project.
# SPDX-License-Identifier: BSD-3-Clause
...
echo "📁 생성 중: models/diffusion/__init__.py"
mkdir -p 'models/diffusion'
cat << 'EOF_RECONSTRUCT' > 'models/diffusion/__init__.py'
# Copyright (c) 2026, Dual Arm Imitation Learning Project.
# SPDX-License-Identifier: BSD-3-Clause
...
echo "📁 생성 중: models/diffusion/diffusion_policy.py"
mkdir -p 'models/diffusion'
cat << 'EOF_RECONSTRUCT' > 'models/diffusion/diffusion_policy.py'
# Copyright (c) 2026, Dual Arm Imitation Learning Project.
# SPDX-License-Identifier: BSD-3-Clause
...
echo "📁 생성 중: models/diffusion/unet1d.py"
mkdir -p 'models/diffusion'
cat << 'EOF_RECONSTRUCT' > 'models/diffusion/unet1d.py'
# Copyright (c) 2026, Dual Arm Imitation Learning Project.
# SPDX-License-Identifier: BSD-3-Clause
...
cat << 'EOF_RECONSTRUCT' > 'requirements.txt'
...
echo "📁 생성 중: scripts/eval.py"
mkdir -p 'scripts'
cat << 'EOF_RECONSTRUCT' > 'scripts/eval.py'
# Copyright (c) 2026, Dual Arm Imitation Learning Project.
# SPDX-License-Identifier: BSD-3-Clause
...
echo "📁 생성 중: scripts/generate_scripted_demos.py"
mkdir -p 'scripts'
cat << 'EOF_RECONSTRUCT' > 'scripts/generate_scripted_demos.py'
# Copyright (c) 2026, Dual Arm Imitation Learning Project.
# SPDX-License-Identifier: BSD-3-Clause
...
echo "📁 생성 중: scripts/replay_demos_kinematic.py"
mkdir -p 'scripts'
cat << 'EOF_RECONSTRUCT' > 'scripts/replay_demos_kinematic.py'
import argparse
import os
import sys
import time
...
echo "📁 생성 중: scripts/train.py"
mkdir -p 'scripts'
cat << 'EOF_RECONSTRUCT' > 'scripts/train.py'
# Copyright (c) 2026, Dual Arm Imitation Learning Project.
# SPDX-License-Identifier: BSD-3-Clause
...
echo "📁 생성 중: teleop/collect_demos.py"
mkdir -p 'teleop'
cat << 'EOF_RECONSTRUCT' > 'teleop/collect_demos.py'
# Copyright (c) 2026, Dual Arm Imitation Learning Project.
# SPDX-License-Identifier: BSD-3-Clause
...
echo "📁 생성 중: teleop/dual_arm_teleop.py"
mkdir -p 'teleop'
cat << 'EOF_RECONSTRUCT' > 'teleop/dual_arm_teleop.py'
# Copyright (c) 2026, Dual Arm Imitation Learning Project.
# SPDX-License-Identifier: BSD-3-Clause
...
echo "✅ 프로젝트 복원이 완료되었습니다!"

echo "📁 생성 중: scripts/eval_parallel.py"
cat << 'EOF_RECONSTRUCT' > 'scripts/eval_parallel.py'
import argparse
import collections
import os
import sys
...
echo "📁 생성 중: run_pipeline.sh"
cat << 'EOF_RECONSTRUCT' > 'run_pipeline.sh'
#!/bin/bash
# ==============================================================================
