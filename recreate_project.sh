...
mkdir -p configs teleop dataset models/bc models/diffusion models/act scripts data checkpoints runs
...
def main():
    ...
    result_path = os.path.join(save_dir, f"eval_results_sequential.json")
...
echo "📁 생성 중: scripts/generate_scripted_demos_parallel.py"
cat << 'EOF_RECONSTRUCT' > 'scripts/generate_scripted_demos_parallel.py'
# Copyright (c) 2026, Dual Arm Imitation Learning Project.
# SPDX-License-Identifier: BSD-3-Clause
